...
Version  : 23.04.2
Release  : 57
URL      : https://download.kde.org/stable/release-service/23.04.2/src/libkipi-23.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/libkipi-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/libkipi-23.04.2.tar.xz.sig
...
%prep
%setup -q -n libkipi-23.04.2
cd %{_builddir}/libkipi-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686503545
mkdir -p clr-build
pushd clr-build
