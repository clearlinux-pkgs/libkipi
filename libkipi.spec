...
Version  : 22.08.0
Release  : 45
URL      : https://download.kde.org/stable/release-service/22.08.0/src/libkipi-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/libkipi-22.08.0.tar.xz
...
%prep
%setup -q -n libkipi-22.08.0
cd %{_builddir}/libkipi-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661532916
mkdir -p clr-build
pushd clr-build
