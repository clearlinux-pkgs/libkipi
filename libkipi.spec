...
Version  : 21.12.0
Release  : 37
URL      : https://download.kde.org/stable/release-service/21.12.0/src/libkipi-21.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/libkipi-21.12.0.tar.xz
...
%prep
%setup -q -n libkipi-21.12.0
cd %{_builddir}/libkipi-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639668910
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkipi-21.12.0/COPYING %{buildroot}/usr/share/package-licenses/libkipi/075bb44a94e785a073154a32aa32554587f330f2
cp %{_builddir}/libkipi-21.12.0/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libkipi/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/libkipi-21.12.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/libkipi/1568befcb09e881d29dd760911ceeb4e2d810884
pushd clr-build
%make_install
popd
