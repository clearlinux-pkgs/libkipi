...
Version  : 23.08.2
Release  : 61
URL      : https://download.kde.org/stable/release-service/23.08.2/src/libkipi-23.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/libkipi-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/libkipi-23.08.2.tar.xz.sig
...
%prep
%setup -q -n libkipi-23.08.2
cd %{_builddir}/libkipi-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697233610
mkdir -p clr-build
pushd clr-build
